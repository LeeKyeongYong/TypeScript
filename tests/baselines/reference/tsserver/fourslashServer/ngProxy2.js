...
Info seq  [hh:mm:ss:mss] Failed to load module 'invalidmodulename' from /../../../node_modules: Error: Could not resolve module
    ...
    at ConfiguredProject2.enablePluginsWithOptions (c:\TypeScript\src\server\project.ts:2844:22)
    at _ProjectService.loadConfiguredProject (c:\TypeScript\src\server\editorServices.ts:2366:17)
    at _ProjectService.createAndLoadConfiguredProject (c:\TypeScript\src\server\editorServices.ts:2310:14)
    at _ProjectService.createLoadAndUpdateConfiguredProject (c:\TypeScript\src\server\editorServices.ts:2316:30)
    at _ProjectService.assignProjectToOpenedScriptInfo (c:\TypeScript\src\server\editorServices.ts:3548:36)
    at _ProjectService.openClientFileWithNormalizedPath (c:\TypeScript\src\server\editorServices.ts:3734:52)
    at FourslashSession.openClientFile (c:\TypeScript\src\server\session.ts:2034:29)
    at open (c:\TypeScript\src\server\session.ts:3236:18)
    at c:\TypeScript\src\server\session.ts:3547:75
